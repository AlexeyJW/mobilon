const aliases: Record<string, string> = {
  ...
  перенос: "Перенесення даних",
  "перенесення даних": "Перенесення даних",
  "перенести дані": "Перенесення даних",
  "все перенести": "Перенесення даних",
  "дані з телефону": "Перенесення даних",
  "перенос даних": "Перенесення даних",
  Ксерокс: "Ксерокопія",
  "ксерокс": "Ксерокопія",
  "ксерокопія": "Ксерокопія",
  "поклейка скла": "Захисне скло",
  "первинне налаштування телефону": "Налаштування",
}
